...
def admin_panel_kb() -> InlineKeyboardMarkup:
    rows = [
        ...
        [InlineKeyboardButton(text="🟢 Keep Alive", callback_data="keep_alive")],
        [InlineKeyboardButton(text="⬅️ Back", callback_data="admin_main")],
    ]
    return InlineKeyboardMarkup(inline_keyboard=rows)


def keep_alive_kb() -> InlineKeyboardMarkup:
    rows = [
        [InlineKeyboardButton(text="🔄 Ping Now", callback_data="ping_now")],
        [InlineKeyboardButton(text="📊 Status", callback_data="ping_status")],
